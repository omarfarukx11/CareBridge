...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-40 bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-10 right-10 text-9xl font-black text-slate-100/50 select-none">
        TRUST
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="lg:col-span-1">
            ...
            <motion.h2 variants={cardVariants} className="text-5xl md:text-6xl font-black text-slate-900 mt-6 leading-tight tracking-tighter">
              Why 12,000+ <br />Families <br />Trust Us.
            </motion.h2>
            <motion.p variants={cardVariants} className="text-slate-500 mt-8 text-xl font-medium leading-relaxed">
              We have spent years refining a caregiving model that prioritizes your safety and medical precision above all else.
            </motion.p>
            
            <motion.div variants={cardVariants} className="mt-12 p-8 bg-white rounded-xl shadow-sm border-l-4 border-primary">
              <p className="text-slate-700 font-bold italic">
                "Care.Bridge didn't just find us a nurse; they found us a lifeline."
              </p>
              <p className="text-sm text-slate-400 mt-4 font-bold">— The Ahmed Family, Dhaka</p>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-2 grid md:grid-cols-2 gap-8">
            {features.map((f, i) => (
              <motion.div 
                ...
                className="p-12 bg-white/60 backdrop-blur-sm rounded-xl border border-slate-200 shadow-sm transition-all duration-300 group hover:shadow-2xl hover:border-primary/20"
              >
                <div className="w-16 h-16 bg-[#0f172a] text-white rounded-xl flex items-center justify-center text-3xl mb-8 group-hover:bg-primary transition-colors">
                  {f.icon}
                </div>
