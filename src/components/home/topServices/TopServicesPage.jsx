        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {topServices.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative bg-neutral-50 rounded-3xl overflow-hidden border border-neutral-100 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500"
            >
              {/* ইমেজ সেকশন */}
